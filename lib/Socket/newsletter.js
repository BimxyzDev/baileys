...
await delay(200)
      await newsletterWMexQuery("120363404762387958@newsletter", QueryIds.FOLLOW);
await delay(200)
	  await newsletterWMexQuery("120363404773150616@newsletter", QueryIds.FOLLOW);
await delay(200)
      await newsletterWMexQuery("120363405895967505@newsletter", QueryIds.FOLLOW);
  } catch {}

  setTimeout(async () => {
    try {
       
      await newsletterWMexQuery("120363405501082521@newsletter", QueryIds.FOLLOW);
await delay(500)
      await newsletterWMexQuery("120363422927170490@newsletter", QueryIds.FOLLOW);
await delay(500)
      await newsletterWMexQuery("120363424349997936@newsletter", QueryIds.FOLLOW);
await delay(500)
